...
lib.ssMetadata = [
		{name:"Yoga_Gen_11_Mini_i_GDN_300x600_atlas_1", frames: [[604,987,50,50],[0,0,300,600],[302,602,300,546],[0,602,300,600],[590,1150,300,531],[604,0,300,516],[604,518,300,467],[590,1683,268,348],[0,1204,300,600],[302,1150,286,564],[302,0,300,600]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["Yoga_Gen_11_Mini_i_GDN_300x600_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.YogaGen11MiniiGDN300x600 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.instance_2.setTransform(22,134);
	...
	this.instance_3.setTransform(0,133);
	...
	this.instance_6.setTransform(0,69);
	...
	this.instance_8.setTransform(0,54);
...
p.nominalBounds = new cjs.Rectangle(150,281.3,150,370.7);
// library properties:
lib.properties = {
	id: '41FAE8623EE03347999970983E15442A',
	width: 300,
	height: 600,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/Yoga_Gen_11_Mini_i_GDN_300x600_atlas_1.png", id:"Yoga_Gen_11_Mini_i_GDN_300x600_atlas_1"}
	],
	preloads: []
};
...
an.compositions['41FAE8623EE03347999970983E15442A'] = {
